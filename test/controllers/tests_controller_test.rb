...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { Destination: @test.Destination, Origin: @test.Origin } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { Destination: @test.Destination, Origin: @test.Origin } }
