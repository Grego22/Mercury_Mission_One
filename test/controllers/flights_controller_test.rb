...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post flights_url, params: { flight: { Destination: @flight.Destination, Origin: @flight.Origin } }
    end
  ...
  test "should update flight" do
    patch flight_url(@flight), params: { flight: { Destination: @flight.Destination, Origin: @flight.Origin } }
